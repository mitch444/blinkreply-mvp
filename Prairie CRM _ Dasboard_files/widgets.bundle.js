...
var month_sale_data_date = localStorage.getItem('month_sale_data_date');
var month_sale_data_date = JSON.parse(month_sale_data_date);

var month_sale_data_amount = localStorage.getItem('month_sale_data_amount');
var month_sale_data_amount = JSON.parse(month_sale_data_amount);

var yaxis_max = localStorage.getItem('yaxis_max');
var yaxis_max = JSON.parse(yaxis_max);
			...
			if (e) {
				var a = parseInt(KTUtil.css(e, "height")),
					...
					i = new ApexCharts(e, {
						...
						xaxis: {
							categories: month_sale_data_date,
							axisBorder: {
								show: !1
							},
							axisTicks: {
